...
```cpp
#define TO_WSTR_MACRO(x) L## #x
inline const std::map<DWORD, std::wstring> g_mapLibpeErrors {
	{ E_CALL_LOADPE_FIRST, TO_WSTR_MACRO(E_CALL_LOADPE_FIRST) },
{ E_FILE_CREATEFILE_FAILED, TO_WSTR_MACRO(E_FILE_CREATEFILE_FAILED) },
{ E_FILE_SIZE_TOO_SMALL, TO_WSTR_MACRO(E_FILE_SIZE_TOO_SMALL) },
{ E_FILE_CREATEFILEMAPPING_FAILED, TO_WSTR_MACRO(E_FILE_CREATEFILEMAPPING_FAILED) },
{ E_FILE_MAPVIEWOFFILE_FAILED, TO_WSTR_MACRO(E_FILE_MAPVIEWOFFILE_FAILED) },
{ E_FILE_MAPVIEWOFFILE_SECTION_FAILED, TO_WSTR_MACRO(E_FILE_MAPVIEWOFFILE_SECTION_FAILED) },
{ E_FILE_SECTION_DATA_CORRUPTED, TO_WSTR_MACRO(E_FILE_SECTION_DATA_CORRUPTED) },
{ E_IMAGE_TYPE_UNSUPPORTED, TO_WSTR_MACRO(E_IMAGE_TYPE_UNSUPPORTED) },
{ E_IMAGE_HAS_NO_DOSHEADER, TO_WSTR_MACRO(E_IMAGE_HAS_NO_DOSHEADER) },
{ E_IMAGE_HAS_NO_RICHHEADER, TO_WSTR_MACRO(E_IMAGE_HAS_NO_RICHHEADER) },
{ E_IMAGE_HAS_NO_NTHEADER, TO_WSTR_MACRO(E_IMAGE_HAS_NO_NTHEADER) },
{ E_IMAGE_HAS_NO_FILEHEADER, TO_WSTR_MACRO(E_IMAGE_HAS_NO_FILEHEADER) },
{ E_IMAGE_HAS_NO_OPTHEADER, TO_WSTR_MACRO(E_IMAGE_HAS_NO_OPTHEADER) },
{ E_IMAGE_HAS_NO_DATADIRECTORIES, TO_WSTR_MACRO(E_IMAGE_HAS_NO_DATADIRECTORIES) },
{ E_IMAGE_HAS_NO_SECTIONS, TO_WSTR_MACRO(E_IMAGE_HAS_NO_SECTIONS) },
{ E_IMAGE_HAS_NO_EXPORT, TO_WSTR_MACRO(E_IMAGE_HAS_NO_EXPORT) },
{ E_IMAGE_HAS_NO_IMPORT, TO_WSTR_MACRO(E_IMAGE_HAS_NO_IMPORT) },
{ E_IMAGE_HAS_NO_RESOURCE, TO_WSTR_MACRO(E_IMAGE_HAS_NO_RESOURCE) },
{ E_IMAGE_HAS_NO_EXCEPTION, TO_WSTR_MACRO(E_IMAGE_HAS_NO_EXCEPTION) },
{ E_IMAGE_HAS_NO_SECURITY, TO_WSTR_MACRO(E_IMAGE_HAS_NO_SECURITY) },
{ E_IMAGE_HAS_NO_BASERELOC, TO_WSTR_MACRO(E_IMAGE_HAS_NO_BASERELOC) },
{ E_IMAGE_HAS_NO_DEBUG, TO_WSTR_MACRO(E_IMAGE_HAS_NO_DEBUG) },
{ E_IMAGE_HAS_NO_ARCHITECTURE, TO_WSTR_MACRO(E_IMAGE_HAS_NO_ARCHITECTURE) },
{ E_IMAGE_HAS_NO_GLOBALPTR, TO_WSTR_MACRO(E_IMAGE_HAS_NO_GLOBALPTR) },
{ E_IMAGE_HAS_NO_TLS, TO_WSTR_MACRO(E_IMAGE_HAS_NO_TLS) },
{ E_IMAGE_HAS_NO_LOADCONFIG, TO_WSTR_MACRO(E_IMAGE_HAS_NO_LOADCONFIG) },
{ E_IMAGE_HAS_NO_BOUNDIMPORT, TO_WSTR_MACRO(E_IMAGE_HAS_NO_BOUNDIMPORT) },
{ E_IMAGE_HAS_NO_IAT, TO_WSTR_MACRO(E_IMAGE_HAS_NO_IAT) },
{ E_IMAGE_HAS_NO_DELAYIMPORT, TO_WSTR_MACRO(E_IMAGE_HAS_NO_DELAYIMPORT) },
{ E_IMAGE_HAS_NO_COMDESCRIPTOR, TO_WSTR_MACRO(E_IMAGE_HAS_NO_COMDESCRIPTOR) }
};
```
