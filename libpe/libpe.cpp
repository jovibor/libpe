...
namespace libpe
{
	...
	constexpr auto LIBPE_VERSION_ULONGLONG = ULONGLONG((static_cast<ULONGLONG>(LIBPE_VERSION_MAJOR) << 48)
	...
	********************************************/
	...
	{
		static LIBPE_INFO stVersion { LIBPE_VERSION_WSTR, LIBPE_VERSION_ULONGLONG };
		return &stVersion;
	}
